  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto pt-24 pb-8 flex flex-col gap-8 px-4 sm:px-6 lg:px-8">
        <div className="w-full min-h-100 bg-muted rounded-[8px] border border-border relative flex flex-col">
          ...
          <div className="Relative w-full h-full p-4 flex flex-col items-center justify-center flex-grow">
            <h1 className="text-7xl font-bold text-center flex mb-4">
        ...
        <div className="w-full min-h-100 bg-muted rounded-[8px] border border-border relative flex flex-col">
          ...
          <div className="absolute bottom-0 left-0 border-l-2 border-b-2 w-10 h-10 rounded-bl-[8px] border-foreground/80" />
          <div className="absolute bottom-0 right-0 border-r-2 border-b-2 w-10 h-10 rounded-br-[8px] border-foreground/80" />
          <div className="Relative w-full h-full p-4 flex flex-col items-center justify-between gap-20 flex-grow">
